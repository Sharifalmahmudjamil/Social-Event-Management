...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-slate-200 text-base-content mt-6">
        <aside>
          ...
          <p>Social Events Ltd.<br/>Providing reliable tech since 2020</p>
        </aside> 
        <nav>
          ...
          <a className="link link-hover">Baby Shower Parties</a>
        </nav> 
        <nav>
          <header className="footer-title">Company</header> 
          <Link to="/about"><a className="link link-hover">About us</a> </Link>
          <Link to="/gallery"><a className="link link-hover">Our Gallery</a> </Link>
